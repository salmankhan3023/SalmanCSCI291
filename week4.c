...
do{
   ...
   {Espresso_PRICE=price_set;
    printf("changed price of espresso to : %f",Espresso_PRICE);
   }
   else if (choose_coffee_price_change == 2)
   {CAPPUCCINO_PRICE = price_set;
    printf("changed price of cappuchino to : %f",CAPPUCCINO_PRICE);
   }
    else if (choose_coffee_price_change == 3)
   {Mocha_PRICE=price_set;
    printf("changed price of mocha to : %f",Mocha_PRICE);
   }}
   else {
    loop_end = false;
